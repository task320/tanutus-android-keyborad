package tokyo.tanutus.ime.core.layout
...
sealed interface KeyAction {
     ...
     * first), rather than being fed into [tokyo.tanutus.ime.core.conversion.KanaConverter] like
     * [Char] is in romaji mode — see [tokyo.tanutus.ime.TanutusImeService.onPunctuationKey].
     */
...
object KeyboardLayouts {
     ...
     * so resolved outside this module — see tokyo.tanutus.ime.editor.EditorInfoActionMapper and
     ...
     * [tokyo.tanutus.ime.TanutusImeService.commitLiteralChar]).
     */
