package tokyo.tanutus.ime.view
...
import tokyo.tanutus.ime.core.gesture.SpaceGestureDetector
import tokyo.tanutus.ime.core.gesture.SpaceGestureListener
import tokyo.tanutus.ime.core.input.KeyboardActionListener
import tokyo.tanutus.ime.core.layout.KeyAction
import tokyo.tanutus.ime.core.layout.KeyDef
import tokyo.tanutus.ime.core.layout.KeyboardLayout
import tokyo.tanutus.ime.core.layout.KeyboardLayouts
import tokyo.tanutus.ime.core.layout.Layer
import tokyo.tanutus.ime.core.layout.RowAlignment
import tokyo.tanutus.ime.core.state.KeyFill
import tokyo.tanutus.ime.core.state.KeyVisualState
import tokyo.tanutus.ime.gesture.SpaceKeyTouchAdapter
import tokyo.tanutus.ime.theme.KeyboardColors
 ...
 * [Layer.SYMBOL] for a given [tokyo.tanutus.ime.core.state.InputMode] (see
...
class KeyboardView
    ...
    constructor(
         ...
         * [tokyo.tanutus.ime.TanutusImeService.refreshKeyboardView]).
         *
         ...
         * [tokyo.tanutus.ime.editor.EditorInfoActionMapper]) — "検索", "送信", … — which
